<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-select v-model="listQuery.role" placeholder="Vai trò" clearable class="filter-item" style="width: 130px">
        <el-option v-for="item in calendarRoleOptions" :key="item.key" :label="item.display_name" :value="item.display_name" />
      </el-select>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      >
        ...
        <el-form-item label="Tài khoản" prop="username">
          ...
          />
          <el-input v-model="temp.username" name="username" v-else disabled />
        </el-form-item>
        <el-form-item
          label="Mật khẩu"
          prop="password"
